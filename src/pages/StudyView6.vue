...
export default {
  setup() {
    ...
    const login = () => {      
      axios.post("http://localhost:8080/api/account/login", state.form, {headers : {"X-Requested-With": "XMLHttpRequest"}}).then((res) => {  
    ...
    const logout = () => {      
      axios.get("http://localhost:8080/api/account/logout").then((res) => {
